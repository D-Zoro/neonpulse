        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                ...
                <h2 className="cyber-text text-2xl font-bold text-purple-300">NEURAL.PROFILE</h2>
              </div>
              
              <div className="space-y-6 text-gray-300 leading-relaxed">
                <p>
                  Welcome to my digital realm. I'm a cyber artist and developer specializing in creating 
                  immersive digital experiences that blur the line between reality and virtuality.
                </p>
                <p>
                  With over 8 years navigating the digital frontier, I architect complex systems, 
                  design stunning interfaces, and bring impossible ideas to life through code and creativity.
                </p>
                <p>
                  My passion lies in pushing the boundaries of what's possible with modern web technologies, 
                  3D graphics, and emerging digital paradigms.
                </p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-purple-500/30 grid grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="cyber-text text-2xl font-bold text-white neon-glow">8+</div>
                  <div className="text-xs text-purple-400">YEARS</div>
                </div>
                <div className="text-center">
                  <div className="cyber-text text-2xl font-bold text-white neon-glow">50+</div>
                  <div className="text-xs text-purple-400">PROJECTS</div>
                </div>
                <div className="text-center">
                  <div className="cyber-text text-2xl font-bold text-white neon-glow">∞</div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                <div className="w-2 h-2 bg-purple-500 mr-4 animate-pulse"></div>
                <h2 className="cyber-text text-2xl font-bold text-purple-300">SKILL.MATRIX</h2>
              </div>
                  ...
                  >
                    <div className="flex justify-between items-end">
                      <div>
                        ...
                        <span className="text-xs text-purple-400 cyber-text">{skill.category}</span>
                      </div>
